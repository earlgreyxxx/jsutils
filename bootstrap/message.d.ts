...
declare export function SetModelessMessagePosition(position:enumPosition ,width?:string) : boolean;
declare export function ModelessMessage(m:ModelessMessageOption|string ,t?:string|null,d?:number) : HTMLElement;
